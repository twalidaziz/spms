						...
						<ul class="nav flex-column">
							<li class="nav-item">
								<a class="nav-link" aria-current="page" href="<?php echo base_url('admin/dashboard') ?>">
									<i data-feather="home">dashboard</i>
					...
					<div class="row">
						<div class="col-12 col-xl-12 mb-4 mb-lg-0">
							<div class="card bg-light">
								<h5 class="card-header">Permit List</h5>
								<div class="card-body">
									<div class="table-responsive">
										<table id="permitTable" class="table table-sm table-hover">
											...
											<tr>
												...
												<td style="text-transform:capitalize"><?php echo $row->value;?></td>
												<td style="text-transform:capitalize">
													<?php if($status[$j]->value == "active") { ?>
														<span class="badge bg-success"><?php echo $status[$j]->value;?></span>
													<?php } else { ?>
														<span class="badge bg-danger"><?php echo $status[$j]->value;?></span>
													<?php } ?>
												</td>
												<td>
													<a href="<?php echo base_url('admin/view_permit/'.$row->id) ?>" class="btn btn-sm btn-outline-primary">
														View
													</a>
												</td>
											<?php   
