                        ...
                        <div class="col-12 col-md-6 mb-4 mb-lg-0 col-lg-4">
                            <div class="card text-dark bg-light">
                                <div class="card-body">
									...
									<a href="<?php echo base_url('admin/edit_semester/'.$semester[0]->id) ?>" style="float:right">
                        ...
                        <div class="col-12 col-md-6 mb-4 mb-lg-0 col-lg-4">
                            <div class="card text-dark bg-light">
                                <div class="card-body">
									...
									<a href="<?php echo base_url('admin/edit_semester/'.$semester[1]->id) ?>" style="float:right">
										<i data-feather="edit"></i>
									</a>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6 mb-4 mb-lg-0 col-lg-4">
                            <div class="card text-dark bg-light">
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo base_url('admin/edit_semester/'.$semester[2]->id) ?>" style="float:right">
										<i data-feather="edit"></i>
									</a>
                                </div>
                            </div>
