				...
				<nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">				
					<div class="position-sticky pt-md-8">
						<ul class="nav flex-column">
							...
							<li class="nav-item">
								<a class="nav-link active" href="<?php echo base_url('admin/permits') ?>">
									...
									<div id="collapseTwo" class="accordion-collapse multi-collapse collapse" aria-labelledby="headingTwo">
										<div class="accordion-body bg-light">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" readonly class="form-control-plaintext" style="text-transform:capitalize" value="<?php echo $user_role[0]->value; ?>">
                                                </div>
                                                <label class="col-sm-2 col-form-label"><b>Email:</b></label>
                                                <div class="col-sm-4">
                                                    <input type="text" readonly class="form-control-plaintext" value="<?php echo $user[0]->email; ?>">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" readonly class="form-control-plaintext" value="<?php echo $user[0]->phone_no; ?>">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <label class="col-sm-2 col-form-label"><b>Account status:</b></label>
                                                <div class="col-sm-4" style="text-transform:capitalize">
                                                    <?php if($user_status[0]->value == "active") { ?>
                                                        <h5><span class="badge bg-success"><?php echo $user_status[0]->value; ?></span><h5>
                                                    <?php } else { ?>
                                                        <h5><span class="badge bg-secondary"><?php echo $user_status[0]->value; ?></span><h5>
                                                    <?php } ?>
                                                </div>
                                            </div>
										</div>
