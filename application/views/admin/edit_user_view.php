						...
						<div class="col-12 col-xl-12 mb-4 mb-lg-0">
							<div class="accordion" id="accordionExample">
								<div class="accordion-item">
									...
									<form method="post" action="<?php echo base_url('admin/edit_user_validation'); ?>">
										<div id="collapseOne" class="accordion-collapse multi-collapse collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
											<div class="accordion-body bg-light">
												<input type="text" hidden name="id" value="<?php echo $user[0]->id; ?>">
												<div class="mb-3 row">
												...
												<div class="mb-3 row">
													...
													<div class="col-sm-4">
														<input type="text" readonly class="form-control-plaintext" style="text-transform:capitalize" value="<?php echo $role[0]->value; ?>">
													</div>
												...
												<div class="mb-3 row">
													...
													<div class="col-sm-4" style="text-transform:capitalize">
														<?php if($status[0]->value == "active") { ?>
															<h5><span class="badge bg-success"><?php echo $status[0]->value; ?></span><h5>
														<?php } else { ?>
															<h5><span class="badge bg-secondary"><?php echo $status[0]->value; ?></span><h5>
														<?php } ?>
													</div>
												</div>
												<div class="mb-3 row">
													<div class="col-sm-12">
														<button name="edit_submit" class="btn btn-primary float-right">
															<i data-feather="save"></i><span class="ml-2">Save changes</span>
														</button>
													</div>
												</div>
											</div>
