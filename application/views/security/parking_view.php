				...
				<nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">				
					<div class="position-sticky pt-md-8">
						<ul class="nav flex-column">
							...
							<li class="nav-item">
								<a class="nav-link active" href="<?php echo base_url('security/parking') ?>">
					...
					<div class="row">
						<div class="col-12 col-xl-12 mb-4 mb-lg-0">
							<div class="card bg-light">
								<h5 class="card-header">Parking List</h5>
								<div class="card-body">
									<div class="table-responsive">
										<table id="permitTable" class="table table-sm table-hover">
											<thead>
												<tr>
													<td><b>#</b></td>
													<td><b>Parking #</b></td>
											...
											<tr>
												<td><?php echo $i++;?>.</td>
												<td style="text-transform:uppercase"><b><?php echo $row->parking_no;?></b></td>
												<td style="text-transform:capitalize"><?php echo $row->permit_id?></td>
												<td style="text-transform:capitalize">
													<?php if($parking_status[$j]->value == "vacant") { ?>
														<span class="badge bg-success"><?php echo $parking_status[$j]->value;?></span>
													<?php } else { ?>
														<span class="badge bg-danger"><?php echo $parking_status[$j]->value;?></span>
													<?php } ?>
												</td>
												<td>
													<a href="<?php echo base_url('security/view_parking/'.$row->id) ?>" class="btn btn-sm btn-outline-primary">
														View
													</a>
												</td>
											<?php   
