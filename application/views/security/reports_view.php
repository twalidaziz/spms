								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="permitTable" class="table table-sm table-hover">
											...
											<tr>
												<td><?php echo $i++;?>.</td>
												<td style="text-transform:uppercase"><b><?php echo $row->report_no; ?></b></td>
												<td><?php echo date("d-m-Y", strtotime($row->date)); ?></td>
												<td style="text-transform:capitalize">
													<?php if($status[$j]->value == "resolved") { ?>
														<span class="badge bg-success"><?php echo $status[$j]->value;?></span>
													<?php } else { ?>
														<span class="badge bg-warning"><?php echo $status[$j]->value;?></span>
													<?php } ?>
												</td>
												<td>
													<a href="<?php echo base_url('security/view_report/'.$row->id) ?>" class="btn btn-sm btn-outline-primary">
														View
													</a>
												</td>
											<?php   
