                                        ...
                                        <div class="accordion-body bg-light">
											...
											<?php } else { ?>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" readonly class="form-control-plaintext" style="text-transform:capitalize" value="<?php echo $semester[0]->value; ?>">
                                                    </div>
                                                    <label class="col-sm-2 col-form-label"><b>Start date:</b></label>
                                                    <div class="col-sm-4">
                                                        <input type="text" readonly class="form-control-plaintext" value="<?php echo date("d-m-Y", strtotime($semester[0]->start_date)); ?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" readonly class="form-control-plaintext" value="<?php echo date("d-m-Y", strtotime($semester[0]->end_date)); ?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-4" style="text-transform:capitalize">
                                                        ...
                                                        <?php } else { ?>
                                                            <h5><span class="badge bg-danger"><?php echo $status[0]->value; ?></span><h5>
                                                        <?php } ?>
                                                    </div>
                                                </div>
                                            <?php } ?>
