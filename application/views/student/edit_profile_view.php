				...
				<nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">				
					<div class="position-sticky pt-md-8">
						<ul class="nav flex-column">
							...
							<li class="nav-item">
								<a class="nav-link" href="<?php echo base_url('student/my_permit') ?>">
									<i data-feather="file-text"></i>
									<span class="ml-2">My Permit</span>
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link active" href="<?php echo base_url('student/profile/'.$this->session->userdata('id')) ?>">
						...
						<div class="col-12 col-xl-12 mb-4 mb-lg-0">
							<div class="accordion" id="accordionExample">
								<div class="accordion-item">
                                    ...
                                    <form method="post" action="<?php echo base_url('student/edit_profile_validation') ?>">
                                        <div id="collapseOne" class="accordion-collapse multi-collapse collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                            <div class="accordion-body bg-light">
                                                <input type="text" hidden name="id" value="<?php echo $this->session->userdata("id") ?>">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" readonly class="form-control-plaintext" value="<?php echo $user[0]->name ?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label class="col-sm-2 col-form-label"><b>Reg. date:</b></label>
                                                    <div class="col-sm-4">
                                                        <input type="text" readonly class="form-control-plaintext" value="<?php echo date("d-m-Y", strtotime($user[0]->date_reg)) ?>">
                                                    </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-4" style="text-transform:capitalize">
                                                        <?php if($user[0]->value == "active") { ?>
                                                            <h5><span class="badge bg-success"><?php echo $user[0]->value; ?></span><h5>
                                                        <?php } else { ?>
                                                            <h5><span class="badge bg-secondary"><?php echo $user[0]->value; ?></span><h5>
                                                        <?php } ?>
                                                    </div>
                                                    <label class="col-sm-2 col-form-label"><b>Phone:</b></label>
                                                    <div class="col-sm-2">
                                                        <input type="text" name="phone_no" class="form-control" value="<?php echo $user[0]->phone_no ?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <div class="col-sm-12">
